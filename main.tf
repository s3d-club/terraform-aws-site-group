...
module "ec2_work" {
  ...
  source = "github.com/s3d-club/terraform-aws-ec2?ref=v0.1.36"
...
module "ecr" {
  ...
  source   = "github.com/s3d-club/terraform-aws-ecr?ref=v0.1.23"
...
module "sg_ingress_open" {
  ...
  source = "github.com/s3d-club/terraform-aws-sg_ingress_open?ref=v0.1.19"
